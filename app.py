...
job_title = st.text_input("Target Job Title", label_visibility="invisible")
job_description = st.text_area("Job Description / Requirements", height=150,label_visibility="invisible")
